...
export const Results = () => {
  ...
  switch (location.pathname) {
    ...
    case '/search':
      return (
        <div className="flex flex-wrap justify-between space-y-6 md:w-6/6 lg:w-8/12 sm:px-56">
          {results?.map(({ link, title, description }, index) => (
            <div key={index} className=" w-full ">
              <a href={link} target="_blank" rel="noreferrer">
                ...
                <p className="text-md break-words dark:text-gray-300 text-gray-600">
                  {description}
                </p>
              </a>
            </div>
    ...
    case '/news':
      return (
        ...
        <div className="flex flex-wrap justify-between space-y-6 lg:w-8/12 sm:px-56 items-center">
